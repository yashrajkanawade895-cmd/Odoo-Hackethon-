...
export const seedAssets = [
  { id: 'a1', tag: 'AF-0114', name: 'MacBook Pro 16"', category: 'Electronics', serial: 'SN-88213X', department: 'Engineering', location: 'HQ - 3F', status: 'allocated', bookable: false, acquisitionDate: '2025-01-15', acquisitionCost: 249900, condition: 'Good' },
  { id: 'a2', tag: 'AF-0207', name: 'Projector Epson X1', category: 'Electronics', serial: 'SN-40213A', department: 'Design', location: 'HQ - 2F', status: 'reserved', bookable: true, acquisitionDate: '2024-11-02', acquisitionCost: 45000, condition: 'Fair' },
  { id: 'a3', tag: 'AF-0322', name: 'Forklift', category: 'Vehicles', serial: 'SN-99001V', department: 'Facilities', location: 'Warehouse B', status: 'under_maintenance', bookable: false, acquisitionDate: '2022-06-20', acquisitionCost: 1250000, condition: 'Needs repair' },
  { id: 'a4', tag: 'AF-0032', name: 'Ergonomic Chair', category: 'Furniture', serial: 'SN-11220F', department: 'Frontend', location: 'HQ - 3F', status: 'allocated', bookable: false, acquisitionDate: '2024-03-10', acquisitionCost: 18500, condition: 'Good' },
  { id: 'a5', tag: 'AF-0450', name: 'Conference Room A', category: 'Rooms', serial: '—', department: 'Facilities', location: 'HQ - 1F', status: 'available', bookable: true, acquisitionDate: '2021-01-01', acquisitionCost: 0, condition: 'Good' },
  { id: 'a6', tag: 'AF-0501', name: 'Dell Monitor 24"', category: 'Electronics', serial: 'SN-77120M', department: 'Engineering', location: 'HQ - 3F', status: 'available', bookable: false, acquisitionDate: '2025-02-18', acquisitionCost: 22000, condition: 'Good' },
]
